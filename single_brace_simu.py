...
from lib import brace, material, opensees_setter, plot_brace
...
if __name__ == "__main__":
    ...
    for name, protocol in protocols.items():
        ...
        numIter, du = modelSetter.set_disp_protocol(protocol, step_len=0.01)
        ...
        bpr = plot_brace.plot_brace_results(out_dir, out_dir, width=5 / 2.54, height=4.5 / 2.54, font_size=9, 
